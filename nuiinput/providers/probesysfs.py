...
information about mtdev, check :py:class:`~nuiinput.providers.mtdev`.
...
if 'NUIINPUT_DOC' in os.environ:
    ...
    from nuiinput.providers.mouse import MouseMotionEventProvider
    from nuiinput.factory import MotionEventFactory
    from nuiinput.config import _is_rpi
